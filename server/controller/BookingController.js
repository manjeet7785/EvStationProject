...
const createBooking = async (req, res) => {
  try {
    const { stationId, bookingDate, bookingTime, duration, chargerType, notes, totalAmount, stationName, stationLocation, paymentMethod, paymentDetails } = req.body;
    ...
    if (overlaps) {
      return res.status(409).json({
        message: '"Booking Unavailable": The selected time slot is already booked for this station. Please choose a different time or explore nearby stations.',
        conflict: {
